...
func init() {
	...
	// with_dhcp requires the managed multicast entitlement on signed Apple platforms.
	// Keep it disabled until com.apple.developer.networking.multicast is approved.
