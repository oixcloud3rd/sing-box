...
func main() {
	...
	newContent, updated0 := findAndReplace(objectsMap, projectContent, []string{"com.akinokaede.sfa"}, newVersion.VersionString())
	newContent, updated1 := findAndReplace(objectsMap, newContent, []string{"com.akinokaede.sfa.standalone", "com.akinokaede.sfa.system"}, newVersion.String())
