...
func main() {
	...
	newContent, updated0 := findAndReplace(objectsMap, projectContent, []string{"io.github.oixcloud3rd"}, newVersion.VersionString())
	newContent, updated1 := findAndReplace(objectsMap, newContent, []string{"io.github.oixcloud3rd.standalone", "io.github.oixcloud3rd.system"}, newVersion.String())
