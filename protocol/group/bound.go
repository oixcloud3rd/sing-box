...
func (b *boundSelectorOutbound) wrapConn(conn net.Conn) net.Conn {
	if !b.interrupt {
		return conn
	}
	return b.selector.interruptGroup.NewConn(conn, true)
}

func (b *boundSelectorOutbound) wrapPacketConn(conn net.PacketConn) net.PacketConn {
	if !b.interrupt {
		return conn
	}
	return b.selector.interruptGroup.NewPacketConn(conn, true)
}
...
func (b *boundSelectorOutbound) ListenPacket(ctx context.Context, destination M.Socksaddr) (net.PacketConn, error) {
	...
	return b.wrapPacketConn(conn), nil
}
...
func (b *boundSelectorOutbound) ListenSerialNetworkPacket(
	...
	return b.wrapPacketConn(conn), destinationAddress, nil
}
...
func (b *boundURLTestOutbound) ListenSerialNetworkPacket(
	...
	return b.urlTest.group.interruptGroup.NewPacketConn(conn, true), destinationAddress, nil
}
